...
//FIC: Services
import {AddOnePresentaInfoAD} from "../../services/remote/post/AddOnePresentaInfoAD.jsx";
//FIC: Helpers
import {PresentaInfoAdValues} from "../../helpers/PresentaInfoAdValues";

const AddPresentaInfoAdModal = ({
                                    AddProductShowModal,
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                const Product = PresentaInfoAdValues(values);
                ...
                await AddOnePresentaInfoAD(datosSeleccionados.IdInstitutoOK, datosSeleccionados.IdProdServOK, datosSecSubdocumentoPresenta.IdPresentaOK, datosSecSubdocumentoPresenta.IdPresentaBK, Product);
...
export default AddPresentaInfoAdModal;