...
//FIC: Services
import {AddInfoAd} from "../../services/remote/post/AddInfoAd.jsx";
//FIC: Helpers
import {InfoAdValues} from "../../helpers/InfoAdValues.jsx";
import MenuItem from "@mui/material/MenuItem";

const AddInfoAdModal = ({AddProductShowModal, setAddProductShowModal, datosSeleccionados}) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                const Product = InfoAdValues(values);
                ...
                await AddInfoAd(datosSeleccionados.IdInstitutoOK, datosSeleccionados.IdProdServOK, Product);
